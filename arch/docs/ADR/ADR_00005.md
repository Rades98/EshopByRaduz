...
V případě potřeby validace nedotazovat data, ptát se druhé domény na výsledek. Synchronizace dat v 
tomto kontextu je myšlena pouze pro eventual consistency scénáře.
